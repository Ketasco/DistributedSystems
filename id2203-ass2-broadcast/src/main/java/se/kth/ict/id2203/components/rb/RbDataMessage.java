...
public class RbDataMessage extends BebDeliver {
    private static final long serialVersionUID = 5909022306150303078L;
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof RbDataMessage) {
            equal = (this.sequenceNumber.equals(((RbDataMessage) other).getSequenceNumber()) && super.getSource().equals(
